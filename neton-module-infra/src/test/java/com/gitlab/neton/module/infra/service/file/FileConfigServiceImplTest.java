package com.gitlab.neton.module.infra.service.file;
...
import com.gitlab.neton.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
import com.gitlab.neton.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import com.gitlab.neton.module.infra.dal.dataobject.file.FileConfigDO;
import com.gitlab.neton.module.infra.dal.mysql.file.FileConfigMapper;
import com.gitlab.neton.module.infra.framework.file.core.client.FileClient;
import com.gitlab.neton.module.infra.framework.file.core.client.FileClientConfig;
import com.gitlab.neton.module.infra.framework.file.core.client.FileClientFactory;
import com.gitlab.neton.module.infra.framework.file.core.client.local.LocalFileClient;
import com.gitlab.neton.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import com.gitlab.neton.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static com.gitlab.neton.framework.test.core.util.RandomUtils.randomLongId;
import static com.gitlab.neton.framework.test.core.util.RandomUtils.randomPojo;
import static com.gitlab.neton.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.gitlab.neton.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("Neton")
