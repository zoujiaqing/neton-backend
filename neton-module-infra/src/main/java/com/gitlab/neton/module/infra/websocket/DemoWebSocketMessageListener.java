package com.gitlab.neton.module.infra.websocket;
...
import com.gitlab.neton.framework.websocket.core.util.WebSocketFrameworkUtils;
import com.gitlab.neton.module.infra.websocket.message.DemoReceiveMessage;
import com.gitlab.neton.module.infra.websocket.message.DemoSendMessage;
...
public class DemoWebSocketMessageListener implements WebSocketMessageListener<DemoSendMessage> {
    ...
    @Autowired(required = false) // 由于 neton.websocket.enable 配置项，可以关闭 WebSocket 的功能，所以这里只能不强制注入
