package com.gitlab.neton.module.infra.controller.admin.codegen;
...
import com.gitlab.neton.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.gitlab.neton.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.gitlab.neton.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.gitlab.neton.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.gitlab.neton.module.infra.convert.codegen.CodegenConvert;
...
import com.gitlab.neton.module.infra.service.codegen.CodegenService;
...
import static com.gitlab.neton.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static com.gitlab.neton.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "neton"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "Neton")
    })
