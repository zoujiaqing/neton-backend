package com.gitlab.neton.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     *
     * 关联 com.gitlab.neton.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
