package com.gitlab.neton.module.infra.controller.admin.logger.vo.apiaccesslog;
...
import com.gitlab.neton.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.gitlab.neton.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "Neton，牛逼！")
    @ExcelProperty("结果提示")
