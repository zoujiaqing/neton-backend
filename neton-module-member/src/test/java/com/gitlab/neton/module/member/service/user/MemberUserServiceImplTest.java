...
import com.gitlab.neton.module.member.controller.app.user.vo.AppMemberUserUpdateMobileReqVO;
...
import com.gitlab.neton.module.member.service.auth.MemberAuthServiceImpl;
 ...
 */
@Disabled
@Import({MemberUserServiceImpl.class, NetonRedisAutoConfiguration.class})
