package com.gitlab.neton.module.pay.framework.pay.core.client.impl.weixin;
...
import com.gitlab.neton.framework.common.util.io.FileUtils;
...
import static com.gitlab.neton.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V2;
import static com.gitlab.neton.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V3;
...
public abstract class AbstractWxPayClient extends AbstractPayClient<WxPayClientConfig> {
    ...
    protected void doInit(String tradeType) {
        ...
        if (Objects.equals(config.getApiVersion(), API_VERSION_V2)) {
            ...
            // 参考 https://gitee.com/netoncode/neton-ui-admin-vue3/issues/ICUE53 和 https://t.zsxq.com/ODR5V
    ...
    private SignatureHeader getRequestHeader(Map<String, String> headers) {
        // 参见 https://gitee.com/zhijiantianya/neton-cloud/issues/ICSFL6
