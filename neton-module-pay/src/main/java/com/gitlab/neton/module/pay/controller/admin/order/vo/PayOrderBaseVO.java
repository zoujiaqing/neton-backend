package com.gitlab.neton.module.pay.controller.admin.order.vo;
...
public class PayOrderBaseVO {
    ...
    @Schema(description = "异步通知地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "http://127.0.0.1:8080/pay/notify")
