package com.gitlab.neton.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.gitlab.neton.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
