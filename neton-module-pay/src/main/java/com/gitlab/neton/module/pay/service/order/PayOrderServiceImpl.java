...
import com.gitlab.neton.module.pay.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://gitee.com/zhijiantianya/neton-cloud/issues/I8SM9H 场景
