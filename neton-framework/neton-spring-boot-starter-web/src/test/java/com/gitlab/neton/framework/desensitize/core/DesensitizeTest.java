package com.gitlab.neton.framework.desensitize.core;

import com.gitlab.neton.framework.common.util.json.JsonUtils;
import com.gitlab.neton.framework.desensitize.core.annotation.Address;
import com.gitlab.neton.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.gitlab.neton.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.gitlab.neton.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("Neton");
        ...
        desensitizeDemo.setRegex("你好，我是Neton");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("Neton");
        ...
        assertEquals("Neton", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "Neton", replacer = "*")
