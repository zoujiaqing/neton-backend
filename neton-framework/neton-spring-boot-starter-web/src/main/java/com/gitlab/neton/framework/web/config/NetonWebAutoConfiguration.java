package com.gitlab.neton.framework.web.config;
...
import com.gitlab.neton.framework.web.core.filter.CacheRequestBodyFilter;
import com.gitlab.neton.framework.web.core.filter.DemoFilter;
import com.gitlab.neton.framework.web.core.handler.GlobalExceptionHandler;
import com.gitlab.neton.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class NetonWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "neton.demo", havingValue = "true")
