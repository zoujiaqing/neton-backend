package com.gitlab.neton.framework.jackson.config;

import com.gitlab.neton.framework.common.util.json.JsonUtils;
import com.gitlab.neton.framework.common.util.json.databind.NumberSerializer;
import com.gitlab.neton.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.gitlab.neton.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class NetonJacksonAutoConfiguration {
