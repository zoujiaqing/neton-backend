package com.gitlab.neton.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${neton.websocket.sender-rocketmq.topic}",
        consumerGroup = "${neton.websocket.sender-rocketmq.consumer-group}",
