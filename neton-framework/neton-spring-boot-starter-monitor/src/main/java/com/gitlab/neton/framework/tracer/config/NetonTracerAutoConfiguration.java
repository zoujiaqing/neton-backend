package com.gitlab.neton.framework.tracer.config;

import com.gitlab.neton.framework.common.enums.WebFilterOrderEnum;
import com.gitlab.neton.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "neton.tracer", value = "enable", matchIfMissing = true)
public class NetonTracerAutoConfiguration {
