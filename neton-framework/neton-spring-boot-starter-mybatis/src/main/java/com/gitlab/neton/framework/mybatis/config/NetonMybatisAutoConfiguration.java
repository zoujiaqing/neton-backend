package com.gitlab.neton.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import com.gitlab.neton.framework.common.util.json.JsonUtils;
import com.gitlab.neton.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${neton.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class NetonMybatisAutoConfiguration {
