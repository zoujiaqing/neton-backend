...
import com.gitlab.neton.framework.common.enums.DocumentEnum;
import com.gitlab.neton.framework.mq.redis.core.RedisMQTemplate;
import com.gitlab.neton.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.gitlab.neton.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import com.gitlab.neton.framework.mq.redis.core.pubsub.AbstractRedisChannelMessageListener;
import com.gitlab.neton.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
...
public class NetonRedisMQConsumerAutoConfiguration {
