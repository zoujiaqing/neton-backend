...
import com.gitlab.neton.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import com.gitlab.neton.module.product.api.sku.dto.ProductSkuRespDTO;
import com.gitlab.neton.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
...
import com.gitlab.neton.module.trade.api.order.dto.TradeOrderRespDTO;
import com.gitlab.neton.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import com.gitlab.neton.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import com.gitlab.neton.module.trade.controller.admin.order.vo.*;
import com.gitlab.neton.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import com.gitlab.neton.module.trade.controller.app.order.vo.*;
import com.gitlab.neton.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import com.gitlab.neton.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import com.gitlab.neton.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import com.gitlab.neton.module.trade.framework.order.config.TradeOrderProperties;
import com.gitlab.neton.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static com.gitlab.neton.framework.common.util.collection.CollectionUtils.convertMap;
import static com.gitlab.neton.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static com.gitlab.neton.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/netoncode/neton-mall-uniapp/issues/ICY7SJ
