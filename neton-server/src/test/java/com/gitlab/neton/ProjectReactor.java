...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.gitlab.neton";
    private static final String ARTIFACT_ID = "neton";
    private static final String PACKAGE_NAME = "com.gitlab.neton";
    private static final String TITLE = "Neton管理系统";
