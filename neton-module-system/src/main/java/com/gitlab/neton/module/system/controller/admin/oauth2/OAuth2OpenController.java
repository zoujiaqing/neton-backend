package com.gitlab.neton.module.system.controller.admin.oauth2;
...
import com.gitlab.neton.framework.common.util.http.HttpUtils;
import com.gitlab.neton.framework.common.util.json.JsonUtils;
import com.gitlab.neton.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import com.gitlab.neton.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import com.gitlab.neton.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import com.gitlab.neton.module.system.convert.oauth2.OAuth2OpenConvert;
import com.gitlab.neton.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import com.gitlab.neton.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import com.gitlab.neton.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import com.gitlab.neton.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import com.gitlab.neton.module.system.service.oauth2.OAuth2ApproveService;
import com.gitlab.neton.module.system.service.oauth2.OAuth2ClientService;
import com.gitlab.neton.module.system.service.oauth2.OAuth2GrantService;
import com.gitlab.neton.module.system.service.oauth2.OAuth2TokenService;
import com.gitlab.neton.module.system.util.oauth2.OAuth2Utils;
...
import static com.gitlab.neton.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.gitlab.neton.framework.common.exception.util.ServiceExceptionUtil.exception0;
 ...
 * 参考大量的开放平台，都是独立的一套 OpenAPI，对应到【本系统】就是在 Controller 下新建 open 包，实现 /platform-api/* 接口，然后通过 scope 进行控制。
