package com.gitlab.neton.module.system.service.social;
...
import com.gitlab.neton.framework.common.util.cache.CacheUtils;
...
import com.gitlab.neton.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.gitlab.neton.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.gitlab.neton.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
...
import com.gitlab.neton.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.gitlab.neton.module.system.dal.dataobject.social.SocialClientDO;
import com.gitlab.neton.module.system.dal.mysql.social.SocialClientMapper;
import com.gitlab.neton.module.system.dal.redis.RedisKeyConstants;
import com.gitlab.neton.module.system.enums.social.SocialTypeEnum;
import com.gitlab.neton.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.gitlab.neton.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.gitlab.neton.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${neton.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${neton.wxa-subscribe-message.miniprogram-state:formal}")
