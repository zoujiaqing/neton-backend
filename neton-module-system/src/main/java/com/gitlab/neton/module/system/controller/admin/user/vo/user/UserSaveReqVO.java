package com.gitlab.neton.module.system.controller.admin.user.vo.user;

import cn.hutool.core.util.ObjectUtil;
import com.gitlab.neton.framework.common.validation.Mobile;
import com.gitlab.neton.module.system.framework.operatelog.core.DeptParseFunction;
import com.gitlab.neton.module.system.framework.operatelog.core.PostParseFunction;
import com.gitlab.neton.module.system.framework.operatelog.core.SexParseFunction;
...
public class UserSaveReqVO {
    ...
    @Schema(description = "用户账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "neton")
    ...
    @Schema(description = "用户邮箱", example = "neton@iocoder.cn")
