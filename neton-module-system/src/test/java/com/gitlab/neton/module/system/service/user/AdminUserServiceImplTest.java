package com.gitlab.neton.module.system.service.user;
...
import com.gitlab.neton.framework.test.core.ut.BaseDbUnitTest;
import com.gitlab.neton.module.infra.api.config.ConfigApi;
import com.gitlab.neton.module.infra.api.file.FileApi;
import com.gitlab.neton.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.gitlab.neton.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.gitlab.neton.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.gitlab.neton.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.gitlab.neton.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.gitlab.neton.module.system.controller.admin.user.vo.user.UserSaveReqVO;
...
import com.gitlab.neton.module.system.dal.dataobject.dept.UserPostDO;
import com.gitlab.neton.module.system.dal.dataobject.user.AdminUserDO;
import com.gitlab.neton.module.system.dal.mysql.dept.UserPostMapper;
import com.gitlab.neton.module.system.dal.mysql.user.AdminUserMapper;
import com.gitlab.neton.module.system.enums.common.SexEnum;
...
import com.gitlab.neton.module.system.service.oauth2.OAuth2TokenService;
...
import static com.gitlab.neton.framework.common.util.collection.SetUtils.asSet;
import static com.gitlab.neton.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.gitlab.neton.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.gitlab.neton.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.gitlab.neton.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.gitlab.neton.framework.test.core.util.AssertUtils.assertServiceException;
import static com.gitlab.neton.framework.test.core.util.RandomUtils.*;
import static com.gitlab.neton.module.system.enums.ErrorCodeConstants.*;
import static com.gitlab.neton.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("netonyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("netonyuanma");
        ...
        assertEquals("netonyuanma", user.getPassword());
    ...
    // testCreatUser_max 测试已删除（多租户功能已移除）
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("netonyuanma"))).thenReturn("java");
