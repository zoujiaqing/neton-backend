package com.gitlab.neton.module.system.service.mail;
...
import com.gitlab.neton.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import com.gitlab.neton.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import com.gitlab.neton.module.system.dal.dataobject.mail.MailTemplateDO;
import com.gitlab.neton.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static com.gitlab.neton.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("Neton")));
        // 测试 code 不匹配
